...
export default function MediaTile({ d, cids, styles }: { d: MediaTileData; cids: string[]; styles: MediaTileStyles }) {
  return (
    <div data-cid={cids[0]} className={cn("2xl:w-62.5 2xl:h-[27.775rem]", styles.className)} aria-hidden={d.ariahidden}>
      ...
      <div data-cid={cids[6]} className={styles.className7}>
        <picture data-cid={cids[7]} className={styles.className8}>
          ...
          {" "}
          <img data-cid={cids[9]} className={cn("2xl:h-111", styles.className10)} data-component={d.kind2} src={d.imgSrc} />
          {" "}
        </picture>
      </div>
    </div>
